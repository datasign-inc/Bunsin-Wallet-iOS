...
final class OpenIdProviderTests: XCTestCase {
    ...
    let presentationDefinition9 = """
        {
          "id": "20b0bb04-4404-47ad-be1e-3922e00b2cd6",
          "input_descriptors": [
            {
              "group": [
                "A"
              ...
              "constraints": {
                "fields": [
                  ...
                  {
                    "path": [
                      "$.vc.credentialSubject.eventName"
                    ],
                    "filter": {
                      "type": "string",
                      "const": ""
          ...
          "input_descriptors": [
            {
              ...
              "constraints": {
                "fields": [
                  ...
                  {
                    "path": [
                      "$.vc.credentialSubject.eventLocation"
                    ],
                    "filter": {
                      "type": "string",
                      "const": ""
    ...
    func testJwtVcJsonMatching1() throws {
        let jwt =
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..WIRDXj95SFDe2HV8DnqGTMAVwvYvvpuFe028fL9UCro"

        let decoder = JSONDecoder()
        decoder.keyDecodingStrategy = .convertFromSnakeCase
        let presentationDefinition = try decoder.decode(
            PresentationDefinition.self, from: presentationDefinition9.data(using: .utf8)!)

        let selected = presentationDefinition.matchJwtVcJsonToRequirement(jwtVcJson: jwt)
        XCTAssertNotNil(selected)
    }

    func testJwtVcJsonMatching2() throws {
        let jwt =
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..WIRDXj95SFDe2HV8DnqGTMAVwvYvvpuFe028fL9UCro"
        ...
        decoder.keyDecodingStrategy = .convertFromSnakeCase
        let presentationDefinition = try decoder.decode(
            PresentationDefinition.self, from: presentationDefinition10.data(using: .utf8)!)
    ...
    func testDirectPostJwtVcJsonAndSdJwt() throws {
        ...
        runAsyncTest {
            ...
            let newAccount = accountManager.nextAccount(
                rp: idProvider.clientId ?? "dummy-client",
                accountUseCase: .defaultIdentifiedAccount
            )
    ...
    func testDirectPostIdTokenAndVpToken() throws {
        ...
        runAsyncTest {
            ...
            let newAccount = accountManager.nextAccount(
                rp: idProvider.clientId ?? "dummy-client",
                accountUseCase: .defaultAnonymousAccount
            )
